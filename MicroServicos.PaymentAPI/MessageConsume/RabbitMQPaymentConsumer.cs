using MicroServicos.PaymentAPI.Messages;
using MicroServicos.PaymentAPI.RabbitMQSender;
using MicroServicos.PaymentProcessor;
using RabbitMQ.Client;
using RabbitMQ.Client.Events;
using System.Text;
using System.Text.Json;

namespace MicroServicos.PaymentAPI.MessageConsume
{
